...
function Footer() {
    return (
        <div className='footer'>
            <div className='container-location'><p className='location'>Contatos:</p></div>
            <section>
            ...
            <section className='container-information'>
                <p className='informations'>Rua: Av. Brasil Sc </p>
                <p className='informations'>Telefone: 99999-9999</p>
                <p className='informations'>E-email: joaov.ojo@gmail.com</p>
                <p className='informations'>Horário de atendimento: Seg - Sex das 08:00 as 18:00</p>
            </section>
